...
![Card Designer Banner](docs/banner.png)
...
```bash
# Clone the repo
git clone https://github.com/tomkim/card-designer.git
...
```bash
mkdir -p ~/.claude/skills
git clone https://github.com/tomkim/card-designer.git ~/.claude/skills/card-designer
